...
changeRoot: <repo-root>/openspec/changes/sp1-a
artifactPaths:
  proposal:
    - <repo-root>/openspec/changes/sp1-a/proposal.md
  specs:
    - <repo-root>/openspec/changes/sp1-a/specs/image-registry-provider/spec.md
  design:
    - <repo-root>/openspec/changes/sp1-a/design.md
  tasks:
    - <repo-root>/openspec/changes/sp1-a/tasks.md
  applyProgress:
    - <repo-root>/openspec/changes/sp1-a/apply-progress.md
  verifyReport:
    - <repo-root>/openspec/changes/sp1-a/verify-report.md
  syncReport:
    - <repo-root>/openspec/changes/sp1-a/sync-report.md
contextFiles:
  proposal:
    - <repo-root>/openspec/changes/sp1-a/proposal.md
  specs:
