...
- Native status consumed as authoritative:
  ...
  - `changeRoot`: `<repo-root>-cap-tenancy/openspec/changes/CAP-TENANCY`
...
- All inspected implementation targets are inside the authoritative workspace `<repo-root>-cap-tenancy`.
