...
- `workspaceRoot`: `<repo-root>-cap-tenancy`
- `allowedEditRoots`: `<repo-root>-cap-tenancy`
...
- Read authoritative local review artifacts from `<repo-root>/.git/gentle-ai/review-transactions/v2/review-0f050718f9d6bbbd/`
