...
`gentle-ai review validate --gate post-apply --cwd <repo-root> --lineage review-a49dc58752713b78` exited 0 with `result=allow`: the authoritative transaction, current repository target, and content-bound artifacts match.
...
| `uv run env PATH=/nonexistent <repo-root>/.venv/bin/python -m pytest -m integration tests/adapters/test_docker_provider_integration.py -q` | 0 | 5 passed, 1 skipped in 0.31s; missing Docker executable produced the declared prerequisite skip | `26a8c0cebd8d31531e2d6d80d38d0a4d997471b06d11d56c62a1dcb615aaa478` |
