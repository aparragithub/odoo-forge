...
`gentle-ai review validate --gate post-apply --cwd <repo-root> --lineage review-e4e6c177120705ff` exited 0 with `result=allow`: authoritative transaction, repository target, and content-bound artifacts match.
