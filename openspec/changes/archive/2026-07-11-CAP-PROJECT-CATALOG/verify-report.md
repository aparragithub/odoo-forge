...
- `changeRoot`: `<repo-root>-cap-parallel-sdd/openspec/changes/CAP-PROJECT-CATALOG`
- `artifacts`: proposal/spec/design/tasks/apply-progress/verify-report present
- `taskProgress`: 6 complete / 0 pending
- `actionContext.mode`: `repo-local`
- `actionContext.workspaceRoot`: `<repo-root>-cap-parallel-sdd`
- `actionContext.allowedEditRoots`: `<repo-root>-cap-parallel-sdd`
...
Executed from `<repo-root>-cap-parallel-sdd`:
