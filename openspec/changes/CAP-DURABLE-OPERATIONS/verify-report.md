...
A bounded-review receipt exists at `.git/gentle-ai/review-transactions/v2/review-ea048455fa7e204d/review-receipt.json` (accessed via the shared worktree common-dir at `<repo-root>/.git/gentle-ai/review-transactions/v2/review-ea048455fa7e204d/`). Verified fields:
