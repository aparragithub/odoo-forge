...
- Workspace root / allowed edit root: `<repo-root>-cap-durable-operations`
...
- Action context: `repo-local`; workspace and only allowed edit root: `<repo-root>-cap-durable-operations`.
...
- Action context: `repo-local`; workspace and allowed edit root: `<repo-root>-cap-durable-operations`.
