# Delta for image-registry-provider
...
(Reason: SP-1 replaces validate-oriented behavior with explicit `exists(digest) -> bool` semantics.)
(Migration: Update CLI/tests/docs to use exists.)
